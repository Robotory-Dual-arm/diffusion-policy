...
# 실행코드
# python bae_eval_real_robot_rightarm_hand_without_wrench.py --input data/outputs/251214_erase_board/checkpoints/epoch=1000-train_loss=0.001.ckpt --output data/results
"""
Usage:
